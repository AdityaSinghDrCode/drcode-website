...
const Skiper19 = () => {
  ...
  return (
    <section
      ref={ref}
      className="mx-auto flex h-[350vh] w-screen flex-col items-center overflow-hidden bg-gradient-to-b from-white to-gray-50 px-4 text-gray-900"
    >
      <div className="mt-42 relative flex w-fit flex-col items-center justify-center gap-5 text-center">
        <h1 className="relative z-10 text-6xl font-bold tracking-[-0.04em] lg:text-8xl">
          From Idea <br /> to Production <br />
          in Weeks
        </h1>
        <p className="relative z-10 max-w-2xl text-xl font-medium text-gray-600">
      ...
      <div className="w-full translate-y-[200vh] rounded-4xl bg-brand pb-10 text-white">
        ...
        <div className="mt-80 flex w-full flex-col items-start gap-5 px-4 font-medium lg:mt-0 lg:flex-row lg:justify-between">
          ...
          <div className="flex w-full flex-wrap items-center justify-between gap-12 uppercase lg:w-fit lg:justify-center">
            <p className="w-fit text-sm">
              Production-Grade <br /> Development
            </p>
            <p className="w-fit text-right text-sm lg:text-left">
              Deploy & Scale <br /> with Confidence
            </p>
          </div>
        </div>
      </div>
