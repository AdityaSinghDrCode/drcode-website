        ...
        >
          ...
          >
            <div className="mb-3 flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-foreground">DrCode</p>
                <p className="text-sm text-muted-foreground">
            ...
            <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
              {TECH.map(({ name, Icon }) => (
                ...
                >
                  ...
                  <span className="type-label truncate normal-case tracking-normal text-foreground/80">
                    {name}
                  </span>
                </div>
              ))}
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm text-muted-foreground">Delivered and production-ready</p>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          {TECH.map(({ name, Icon, position }, i) => (
            ...
            >
              ...
              <span className="type-label tracking-[0.14em] text-muted-foreground">
                {name}
              </span>
            </div>
          ))}
          ...
          >
            <div
              className={cn(
                "flex h-[5.5rem] w-[5.5rem] flex-col items-center justify-center rounded-3xl border-2 border-brand/35 bg-card shadow-[0_20px_60px_-28px_hsl(var(--brand)/0.4)]",
            ...
            >
              ...
              <span className="type-label mt-0.5 text-brand">
                Stack
              </span>
            </div>
          </div>
